...
public class MDCJacksonAdapterFactoryTest extends JacksonTest implements MDCTestConstants {
    public MDCJacksonAdapterFactoryTest() {
        super(b -> b.registerModule(new MDCModule()));
    }
